...
CompoundButton.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        emailAsUsername.setSelected(EmailAsUsername);
        generateUsername.setSelected(GenUsername);
        generatePassword.setSelected(GenPwd);
        editUsername.setSelected(EditUsername);
        showPassword.setSelected(EditPassword);
        add.setChecked(Add);
